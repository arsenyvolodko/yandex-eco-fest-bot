...
async def handle_third_question_answer(call: CallbackQuery):
    ...
    score = f"<b>{cnt}</b> {score_string}"
    text = f'Ваш результат: {score}\n\n'
    if cnt < 4:
        extra_text = "К сожалению, вы не набрали нужное количество баллов.\nНе расстраивайся! Если хотите узнавать больше об экологичных привычках, подписывайтесь на наш канал!"
    else:
        extra_text = "Поздравляем! Вы набрали нужное количество баллов. Подойдите на ресепшен и получи свой подарок\n\nА если хотите узнавать больше об экологичных привычках, подписывайтесь на наш канал!"
