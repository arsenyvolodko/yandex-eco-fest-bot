...
PERSONAL_WORK_MEDIA_URL = f"{MEDIA_DIR}/my_progress.png"
MAIN_MENU_MEDIA_URL = f"{MEDIA_DIR}/menu_picture.png"
KENT_MEDIA_URL = f"{MEDIA_DIR}/kent.png"

MAIN_MAP_MEDIA_URL = f"{MEDIA_DIR}/small_mapp.png"
BIG_MAP_MEDIA_URL = f"{MEDIA_DIR}/big_mapp.png"
