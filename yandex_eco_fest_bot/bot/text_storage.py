...
PERSONAL_SCORE_TEXT = (
    ...
    "Ваша команда набрала <b>{team_score}</b> 🌱кредитов\n"
...
TOTAL_TEST_SCORE = "Ты набрал <b>{score}</b> за тест!"
...
QUESTION_1 = ("<b>Возврат пакетов в Лавке ― это не про лайки, а про циклы</b>\n"
              "Какую маркировку должен иметь пакет-маечка, чтобы курьер забрал его на переработку? Можно сдать ненужные пакеты в любом количестве, главное — чистыми и сухими.\n\n"
              "A) 1 PETE\nB) 2 HDPE\nC) 2 PE-HD\nD) Любой полиэтилен")
