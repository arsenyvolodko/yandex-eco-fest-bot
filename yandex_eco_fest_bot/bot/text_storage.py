...
INTRO_TEXT = "Квест содержит 9 интерактивных зон. Выполняя задания (экомиссии), мы собираем горошины Go Green для общего и личного прогресса. Собери <b>70</b> горошин Go Green и получи <b>спешл напиток от Surf Coffee.</b>\n\nА за успешное прохождение мини-теста забирай аксессуар из переработанного пластика — <b>NFC-брелок от Recycle Object.</b>"
