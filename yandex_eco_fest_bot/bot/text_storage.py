...
MAIN_MAP_TEXT = "Держи карту фестиваля! Также <b>на сцене</b> сегодня тебя ждет:\n\n<u>14:00</u> Аукцион СТМ Маркета\n<u>16:00</u> Хедлайнер DJ Ozero Sveta\n\nВсе активности мероприятия работают до <u>18:00</u>"
...
INTRO_TEXT = "Квест содержит 8 интерактивных зон. Выполняя задания (экомиссии), мы собираем горошины Go Green для общего и личного прогресса. Собери <b>70</b> горошин Go Green и получи <b>спешл напиток от Surf Coffee.</b>\n\nА за успешное прохождение мини-теста забирай аксессуар из переработанного пластика — <b>NFC-брелок от Recycle Object.</b>"
