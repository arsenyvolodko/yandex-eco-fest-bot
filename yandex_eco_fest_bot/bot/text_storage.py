...
END_TEXT = "Спасибо, что были с нами на Eco Tech Fest!\nПоделитесь, пожалуйста, своей обратной связью по мероприятию"
PRE_TEST_TEXT = "Этот мини-тест поможет понять насколько вы ориентируетесь в практиках заботы об экологии. 4+ верных ответа — и вас ждет NFC-брелок от Recycle Object на стойке регистрации."
# Team score
