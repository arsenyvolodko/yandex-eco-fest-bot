...
INTRO_TEXT = "Выполняй экомиссии и собирай горошины → Заберай свой Спешл от Surf Coffee\nРеши тест → получи NFC-брелок от Recycle Object"
...
PRE_TEST_TEXT = "Этот мини-квиз — короткий чек на то, как ты ориентируешься в практиках заботы об экологии.\nНаберёшь 4+ верных ответа из 5 — на стойке регистрации тебя ждёт NFC-брелок от Recycle Object"
# Team score
